...
function Coin({
    ...
    return (
        <div className="flex justify-left border-t h-[60px] text-sm align-middle text-center w-min md:w-full">
            ...
            <div className="flex items-center self-center justify-left lg:w-[350px] w-[100px] h-30 flex-shrink-0">
                <img className="sm:mr-5 mr-2" width="18" src={image} alt={name} />

                <div className="font-bold items-center w-[115px] text-left hidden sm:block">{name}</div>
